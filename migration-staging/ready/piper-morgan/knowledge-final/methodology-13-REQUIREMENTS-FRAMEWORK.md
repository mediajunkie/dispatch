...
- If test expects behavior that doesn't exist â†’ Fix implementation
- If test expects interface conflicting with domain â†’ Fix test
- When uncertain â†’ Check services/domain/models.py first
