...
- **Title**: Title Case for main blog post title only
- **Date**: Italicized *Month DD* format directly under title (e.g., *August 26*)
- **Headings**: Sentence case for all internal section headings
- **Footer Format**: 
  ```
  *Next on Building Piper Morgan: [preview of upcoming content with personal insight].*
  
  *[Personal question to readers about their own experiences]*
  ```

### Footer Examples
- *Next on Building Piper Morgan: The Intelligence Trifecta in Action, as we finally test the complete Morning Standup with Issues + Documents + Calendar working together.*
- *Have you ever worked so systematically that the approach itself became invisible?*
...
- Acknowledges when something is legitimately complex

### Storytelling Mode
- Sets scenes with specific details
- Uses dialogue when recounting conversations
- Builds suspense even in technical narratives
- Connects personal experience to broader insights

### Reflective Mode
- More philosophical and contemplative
- References personal growth and learning
- Connects current work to past experiences
- Often includes vulnerability about mistakes or uncertainty